	<div id="pawsmedia" class="op-panel charcoal">
		<div class="op-panelctrl solid-black">
			<div data-close="pawsmedia" class="op-panelbt op-bt-close">
				...
				<div class="block-wrap">
					<div class="block bw25 md-100 sm-100 xs-100">
						<div class="banana chonk strawberry-t black-t-s" style="padding: 1em 1.25em; margin: 0 1.5em 0 0;">
							...
							<h4 class="lucida heavy flow-text"><i class="bi bi-tv"></i> Media Stream</h4>
						</div>
						...
						<ul class="tiles lucida black-t-s smoke-t">
							...
							<li><a href="javascript:void(0);" data-panelid="my_videos" data-pos="right" class="op-tab">
								<span class="title"><i class="bi bi-folder grayscale"></i> Browse Videos</span></a></li>
							<li><a href="javascript:void(0);" data-panelid="fam-fu-myvideo" data-pos="right" class="op-tab">
								<span class="title"><i class="bi bi-upload grayscale"></i> Upload Videos</span></a></li>
						</ul>
					</div>
					<div class="block bw75 bh85 xs-100 sm-100 md-100">
						<div class="block-wrap">
							<div class="block bw100 bh85">
								<iframe src="cat/paws/module/page_edit_podcasts.php" title="Media Editor" style="border: none; overflow-y: none; width: 100%; margin: 0 auto; padding: 0; height: 100%;"></iframe>
							</div>
						</div>
					</div>
				</div>
