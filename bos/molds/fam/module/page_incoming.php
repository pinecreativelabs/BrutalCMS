...
if($fam_cm=='relative'){
$miscdir = 'app/files/incoming/';
} else {$miscdir = $bosdir.'app/files/incoming/';}

$miscpath = $pdir.'/app/files/incoming/';
$tofilespath = $pdir.'/app/files/';
...
<head>
    <meta charset="utf-8">
    <title>FAM: Incoming Files</title>
			...
			if ($opendirectory = opendir($miscpath)){
				...
				foreach($files as $file) {
					if(is_file($miscpath.$file)){
						...
						$movetofilespath = $tofilespath.$file;
						...
						echo "<a href=\"".$miscdir.$file."\" target=\"_blank\" data-path=\"".$filepath."\" data-tpath=\"".$movetofilespath."\" id=\"fid_misc_".$fid."\">".$file."</a>";
						...
						echo "<div class=\"move invert-h\" data-fid=\"".$fid."\"><img src=\"../../../core/css/images/folder-move.png\" id=\"move_".$fid."\"/></div>";
						echo "<div class=\"del sepia-h\" data-fid=\"".$fid."\"><img src=\"../../../core/css/images/x-delete.png\" id=\"fid_thumb_misc_".$fid."\"/></div></div>";
					}
				}
			}
		}
...
<div id="help" style="display:none;">
	<div class="padded rounded b-s-k lime-b depixel" style="background: #000; max-width: 600px;">
		...
		<p><img src="../../../core/css/images/folder-move.png" alt="move" class="micro-thumb"/> <small>[Moves file to <em>shared files</em> folder.]</small></p>
...
$(document).ready(function(){
	...
	$('.fmisc .move').click(function(){
		...
		$.ajax({
			...
			success: function(response){
				if(response == 1){
					$("#move_" + id).attr("src","../../../core/css/images/moved-to-files.png");
				} else { $("#move_" + id).attr("src","../../../core/css/images/error.jpg");}
			}
		});
	});
});
