...
$miscdir = $bosdir.'app/files/';
$copypath = $pdir.'/app/users/'.$current_user.'/files/';
$miscpath = $pdir.'/app/files/';
$trashpath = $pdir.'/app/files/trash/';

$files5 = scandir($miscpath);
$fc_misc = count($files5)-5;
...
<a href="#fu" class="add-btn brick" data-modal-open>&#10010; New Upload</a>
<button class="reloadbtn" onclick="reloadPage() ">&#10227;</button>
<a href="#help" class="helpbtn" data-modal-open>&#9432; HELP</a>
<header><div style="display: block; height: 20px; margin: 0; width: 100%;"></div>
			...
			if ($opendirectory = opendir($miscpath)){
				...
				foreach($files as $file) {
					if(is_file($miscpath.$file)){
						...
						echo "<a href=\"".$miscdir.$file."\" target=\"_blank\" data-path=\"".$filepath."\" data-tpath=\"".$trashfilepath."\" data-cpath=\"".$copyfilepath."\" id=\"fid_misc_".$fid."\">".$file."</a>";
						
						//(exif_imagetype($miscdir.$file)==true)
						
						$imgthumbarray = array("bmp","gif","ico","jpg","jpeg","png","svg","tif","tiff","wbmp","webp");
						if (in_array($ext,$imgthumbarray)){ 
							if($fsbytes <= $thumbit){
								echo "<div class=\"thumb\"><img src=\"".$miscdir.$file."\" class=\"tiny-thumb crop\" /></div>";
							} else {
								echo "<div class=\"thumb\"><img src=\"../../../core/files/images/icon-dune.jpg\" class=\"tiny-thumb crop\" /></div>";
							}
						} 
						/*elseif(in_array($ext,$ftarray)){
							echo "<div class=\"thumb\"><img src=\"../../../core/files/images/icons/".$ext.".png\" class=\"tiny-thumb crop\" id=\"fid_thumb_misc_".$fid."\" /></div>";
						} else { 
							echo "<div class=\"thumb\"><img src=\"../../../core/css/images/nif.png\" class=\"tiny-thumb crop\" id=\"fid_thumb_misc_".$fid."\" /></div>";
						}*/
						...
						if($famcopy=='true'){echo "<div class=\"copyfile invert-h\" data-fid=\"".$fid."\"><img src=\"../../../core/css/images/copy-paste.png\" id=\"copied_".$fid."\"/></div>";}
						echo "<div class=\"del sepia-h\" data-fid=\"".$fid."\"><img src=\"../../../core/css/images/trash.png\" class=\"tiny-thumb\" id=\"trashed_".$fid."\"/></div></div>";
					}
				}
			}
		}
...
<div id="fu" style="display:none;">
	<div class="container-960">
		<h4 class="monolisk flow-text heavy" style="margin: 0; padding: 0.5em;"><i class="bi bi-upload sepia"></i> File Uploader</h4>
...
<div id="help" style="display:none;">
	<div class="padded rounded b-s-k lime-b depixel" style="background: #000; max-width: 600px;">
		...
		<?php if($famcopy=='true'){?><p><img src="../../../core/css/images/copy-paste.png" alt="move" class="micro-thumb"/> <small>[Copies file to current user's <em>files</em> folder.]</small></p><?php } ?>
		<p><img src="../../../core/css/images/trash.png" alt="move" class="micro-thumb"/> <small>[Moves file to <em>Trash</em> folder.]</small></p>
	</div>
</div>
...
$(document).ready(function(){
	$('.fmisc .del').click(function(){
		...
		$.ajax({
			url: 'trash.php', type: 'post', data: {path: aElement_href, tpath: bElement_href},
			success: function(response){
				if(response == 1){
					$("#trashed_" + id).attr("src","../../../core/css/images/deleted.png");
				} else { $("#trashed_" + id).attr("src","../../../core/css/images/error.jpg");}
			}
		});
	});
	$('.fmisc .copyfile').click(function(){
		var id = $(this).data('fid');
		var aElement_href = $('#fid_misc_'+id ).attr("data-path");
		var bElement_href = $('#fid_misc_'+id ).attr("data-cpath");
		$.ajax({
			url: 'copy.php', type: 'post', data: {path: aElement_href, cpath: bElement_href},
			success: function(response){
				if(response == 1){
					$("#copied_" + id).attr("src","../../../core/css/images/copied.png");
				} else { $("#copied_" + id).attr("src","../../../core/css/images/error.jpg");}
			}
		});
	});
});
