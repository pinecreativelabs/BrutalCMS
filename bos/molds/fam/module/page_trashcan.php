...
if($fam_cm=='relative'){
$miscdir = 'app/files/trash/';
} else {$miscdir = $bosdir.'app/files/trash/';}

$miscpath = $pdir.'/app/files/trash/';
$trashpath = $pdir.'/app/files/';
...
<div id="help" style="display:none;">
	<div class="padded rounded b-s-k lime-b depixel" style="background: #000; max-width: 600px;">
		...
		<p><img src="../../../core/css/images/trash-undo.png" alt="untrash" class="micro-thumb"/> <small>[Restores file to <em>files</em> folder.]</small></p>
