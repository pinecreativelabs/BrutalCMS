...
<head>
	...
	<style>
		...
		.tags li {background: #333; border: 1px solid #333; border-radius: 3px; -webkit-border-radius: 3px;}
		.tags li:hover {background: #6e6e6e;}
		.tags li a {padding: 6px;}
		.tags li a:hover{color: #fefefe;}
		...
		#csvtable td input {color: #ffff00;}
		#csvtable thead tr th {text-align: left;}
		#csvtable tr.success {background: #6e6e6e;}
		<?php if($crude_readonly=='true'){ ?>
		#csvtable td:last-child {display:none !important;}
		<?php } if($crude_delrecords=='false'){?>
...
<div class="block-wrap">
	...
	<?php if(!isset($csv)) {} else {
		...
		<form>
			...
			<?php if($crude_readonly=='false'){ if($crude_addrecords=='true'){?>
...
<!-- Initiate modal -->
<div class="modal"><div class="modal-inner rounded">
