			...
			<div class="container-fluid">
				<div class="block-wrap">
					<div class="block bw25 md-100 sm-100 xs-100">
						<div class="lush chonk rice-t-s apple-t" style="padding: 1em 1.25em; margin: 0 1.5em 0 0;">
							<h3 class="lucida bold" style="font-size: 2.5em;">EDU <i class="bi bi-edu"></i></h3>
							<h4 class="lucida heavy flow-text">Educational Deployment Utility</h4>
						</div>
					</div>
