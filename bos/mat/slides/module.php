	<div id="slides" class="op-panel charcoal">
		<div class="op-panelctrl solid-black">
			<div data-close="slides" class="op-panelbt op-bt-close">
			...
			<div class="container-fluid">
				<div class="block-wrap">
					<div class="block bw25 md-100 sm-100 xs-100">
						<div class="violence chonk poolwater-t black-t-s" style="padding: 1em 1.25em; margin: 0 1.5em 0 0;">
							<h3 class="lucida bold" style="font-size: 2.5em; ">SLIDES <i class="bi bi-file"></i></h3>
							<h4 class="lucida heavy flow-text">Presentation Management</h4>
						</div>
					</div>
					<div class="block bw75 md-100 sm-100 xs-100" style="padding: 1em 2em 1em 0;">
						<div class="padded warning lucida">
