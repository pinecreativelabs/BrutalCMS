	<div id="blueprint-themes" class="op-panel charcoal">
		<div class="op-panelctrl solid-black">
			<div data-close="blueprint-themes" class="op-panelbt op-bt-close">
			...
			<div class="container-fluid">
				<div class="block-wrap">
					<div class="block bw25 md-100 sm-100 xs-100">
						<div class="blueprint chonk charcoal-t-s" style="padding: 1em 1.25em; margin: 0 1.5em 0 0;">
							<h3 class="lucida bold" style="font-size: 2.5em; ">Blueprint <i class="bi bi-grid"></i></h3>
							<h4 class="lucida heavy flow-text"><i class="bi bi-rainbow"></i> Themes</h4>
						</div>
					...
					<div class="block bw75 xs-100 sm-100 md-100">
						<div class="block-wrap">
							<div class="block bw100 bh85">
								<iframe src="bat/blueprint/module/page_edit_themes.php" title="Themes Editor" style="border: none; overflow-y: none; width: 100%; margin: 0 auto; padding: 0; height: 100%;"></iframe>
							</div>
						</div>
					</div>
				</div>
