...
foreach($generalfile->setting as $setting){ 
	...
	$region = $setting->locale['region'];
	$city = $setting->locale['city'];
	...
	$draggable = $setting->bosui['draggable'];
	// dev resources
	...
	$pw_strength = $setting->access['pwstrength'];
	$pw_encrypt = $setting->access['pwencrypt'];
	$pal_default = $setting->access['pal_default'];
	$login_mode = $setting->access['login'];
	$session_timeout = $setting->access['timeout'];
