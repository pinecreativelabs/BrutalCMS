	<div id="entity-groups" class="op-panel charcoal">
		<div class="op-panelctrl solid-black">
			<div data-close="entity-groups" class="op-panelbt op-bt-close">
				...
				<div class="block-wrap">
					<div class="block bw25 md-100 sm-100 xs-100">
						<div class="aqua chonk sapphire-t-s rice-t" style="padding: 1em 1.25em; margin: 0 1.5em 0 0;">
							...
							<h4 class="lucida heavy flow-text"><i class="bi bi-corners"></i> Entity Groups</h4>
						</div>
					...
					<div class="block bw75 bh85 xs-100 sm-100 md-100">
						<div class="block-wrap">
							<div class="block bw100 bh85">
								<iframe src="dat/crude/module/page_edit_groups.php" title="Data Groups Editor" style="border: none; overflow-y: none; width: 100%; margin: 0 auto; padding: 0; height: 100%;"></iframe>
							</div>
						</div>
					</div>
				</div>
