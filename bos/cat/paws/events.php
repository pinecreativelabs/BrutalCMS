	<div id="events" class="op-panel charcoal">
		<div class="op-panelctrl solid-black">
			<div data-close="events" class="op-panelbt op-bt-close">
				...
				<div class="block-wrap">
					<div class="block bw25 md-100 sm-100 xs-100">
						<div class="banana chonk strawberry-t black-t-s" style="padding: 1em 1.25em; margin: 0 1.5em 0 0;">
							...
							<h4 class="lucida heavy flow-text"><i class="bi bi-calendar"></i> Events</h4>
						</div>
						...
						<ul class="tiles lucida black-t-s smoke-t">
							<li><a href="javascript:void(0);" data-panelid="eventstream" data-pos="fade" class="op-tab">
								<span class="title"><i class="bi bi-watch"></i> View Event Stream</span></a></li>
					...
					<div class="block bw75 bh85 xs-100 sm-100 md-100">
						<div class="block-wrap">
							<div class="block bw100 bh85">
								<iframe src="cat/paws/module/page_edit_events.php" title="Events Editor" style="border: none; overflow-y: none; width: 100%; margin: 0 auto; padding: 0; height: 100%;"></iframe>
							</div>
						</div>
					</div>
				</div>
