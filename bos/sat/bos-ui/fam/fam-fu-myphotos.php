...
?>
	...
	<div id="fam-fu-myphotos" class="op-panel charcoal">
		<div class="op-panelctrl solid-black">
			<div data-close="fam-fu-myphotos" class="op-panelbt op-bt-close">
				...
				<div class="block-wrap">
					<div class="block b100">
						<div class="clean chonk fossil-t charcoal-t-s" style="padding: 0px 16px 8px 16px; display: inline-block; margin: 0 1.5em 0 0; min-width: 33vw;">
							...
							<h4 class="lucida heavy flow-text">File Uploader | <i class="bi bi-camera"></i> My Photos</h4>
						</div>
					</div>
				</div>
				<div class="block-wrap">
					...
					<div class="block bw50 md-100 sm-100 xs-100" style="padding: 1em 2em 1em 0;">
						<p class="smoke-t lucida padded warning" style="font-size: 1.1em;">All files will be uploaded to:<br />
							<span class="bigger bold">/pat/users/<?php echo $_SESSION['userName'];?>/photos/</span>
						...
						<div class="fu padded unset-bg">
							<input class="FU" type="file" path="pat/users/<?php echo $_SESSION['userName'];?>/photos/" startOn="manually" buttonCaption="Upload" buttonClass="fu-fb" multi="true" afterUpload="link" maxSize="<?php echo $maxFileSize; ?>" fileType="image/bmp,image/png,image/jpeg,image/gif,image/tiff,image/emf,image/wmf"/>
						</div>
					</div>
					<div class="block bw25 md-100 sm-100 xs-100" style="padding: 1em 2em 1em 0;">
