<?php 
$pdir4 = realpath(__DIR__. '/../../..');

if($fam_cm=='relative'){
$doxdir = 'rat/repo/files/docs/';
} else {$doxdir = $bosdir.'rat/repo/files/docs/';}

$docspath = $pdir4.'/rat/repo/files/docs/';

$files4 = scandir($docspath);
$fc_docs = count($files4)-2;
if(($fc_docs>=51)&&($fc_docs<=150)){$fca_pag = 10;}
elseif(($fc_docs>=151)&&($fc_docs<=300)){$fca_pag = 15;}
elseif(($fc_docs>=301)&&($fc_docs<=400)){$fca_pag = 20;}
elseif($fc_docs>400){$fca_pag = 25;}
else {$fca_pag = 5;}
?>

	<div id="fam-docs" class="op-panel charcoal">
		<div class="op-panelctrl solid-black">
			<div data-close="fam-docs" class="op-panelbt op-bt-close">
				...
				<div class="block-wrap">
					<div class="block bw75 md-100 sm-100 xs-100">
						<div class="clean chonk fossil-t charcoal-t-s" style="padding: 0px 16px 8px 16px; display: inline-block; margin: 0 1.5em 0 0; min-width: 33vw;">
							<h3 class="lucida bold" style="font-size: 2.5em; "><i class="bi bi-file"></i> FAM / Document Files</h3>
							<h4 class="lucida heavy flow-text"><?php echo $fc_docs; ?> files</h4>
						</div>
					</div>
					<div class="block bw25 md-100 sm-100 xs-100 center">
						<ul class="tiles lucida black-t-s" style="margin: 0 auto; padding: 0.5em; max-width: 300px;">
							<li style="text-align: left;"><a href="javascript:void(0);" data-panelid="fam-fu-docs" data-pos="fade" class="op-tab">
				...
				<div class="block-wrap">
					<div class="block bw75 md-100 sm-100 xs-100" style="padding: 1em 2em 1em 0;">
						<p class="smoke-t padded warning">
							...
							<span style="font-size:1.25em;" class="arial"><?php echo $docspath;?></span>
						...
						<div class="paginate-<?php echo $fca_pag;?> file-list" style="margin-left: 0; padding: 0.5em; max-width: 90%;">
						  <div class="lucida rice-t items">
							<?php if (is_dir($docspath)){
							if ($opendirectory = opendir($docspath)){
							$fid = 0;
							while (($file = readdir($opendirectory)) !== false){
								if(is_file($docspath.$file)){
									$fid++;
									$fsbytes=filesize($docspath.$file);
									...
									echo "<div class=\"fi fdocs\">";
									//<div class=\"chk\"><input class=\"chki\" type=\"checkbox\" id=\"\" name=\"files[]\" value=\"".$file."\"></div>
									echo "<div class=\"thumb\">";
									if ((exif_imagetype($doxdir.$file)==true)||($ext=="svg")){ 
										echo "<img src=\"".$doxdir.$file."\" class=\"tiny-thumb crop\" id=\"fid_thumb_docs_".$fid."\" />";
									} elseif(in_array($ext,$ftarray)){
										echo "<img src=\"fat/fam/icons/".$ext.".png\" class=\"tiny-thumb crop\" id=\"fid_thumb_docs_".$fid."\" />";
									}
									else { echo "<img src=\"bat/css/images/nif.png\" class=\"tiny-thumb crop\" id=\"fid_thumb_docs_".$fid."\" />";}
									echo "</div><a href=\"".$doxdir.$file."\" target=\"_blank\" data-path=\"".$filepath."\" id=\"fid_docs_".$fid."\">".$file."</a><div class=\"fsize\">".$fsize."</div>
								<div class=\"copier copy-attr\" data-copy-on-click=\"#fid_docs_".$fid."\"><i class=\"bi bi-clipboard\"></i></div>
					...
					<div class="block bw25 md-100 sm-100 xs-100" style="padding: 1em 2em 1em 0;">
						...
						<ul class="tiles lucida black-t-s">
							...
							<li><a href="javascript:void(0);" data-panelid="fam-vid" data-pos="right" class="op-tab">
								<span class="title"><i class="bi bi-video"></i> Vido Files</span>
							</a></li>
