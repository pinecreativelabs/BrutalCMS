...
<script src="core/jab/plugins/upload.js" type="text/javascript"></script>
	<div id="fam-fu-aud" class="op-panel charcoal">
		<div class="op-panelctrl solid-black">
			<div data-close="fam-fu-aud" class="op-panelbt op-bt-close">
			...
			<div class="container-fluid">
				<div class="block-wrap">
					<div class="block bw25 md-100 sm-100 xs-100" style="padding: 1em 2em 1em 0;">
						<div class="clean chonk monolisk charcoal-t" style="padding: 1em 1.25em; margin: 0 1.5em 0 0;">
							<h3 style="font-size: 2.5em; "><strong><i class="bi bi-upload"></i> FU</strong></h3>
							<h4 class="heavy flow-text">File Uploader | <i class="bi bi-audio"></i> Audio</h4>
						</div>
					...
					<div class="block bw50 md-100 sm-100 xs-100" style="padding: 1em 2em 1em 0;">
						<p class="smoke-t lucida padded warning" style="font-size: 1.1em;">All files will be uploaded to:<br />
							<span class="bigger bold">/rat/repo/files/audio/</span>
						...
						<div class="fu padded unset-bg">
							<input class="FU" type="file" path="rat/repo/files/audio/" startOn="manually" buttonCaption="Upload" buttonClass="fu-fb" multi="true" afterUpload="link" maxSize="<?php echo $maxFileSize; ?>" fileType="audio/aac,audio/basic,audio/DV,audio/flexfec,audio/MPA,audio/mp4,audio/ogg,audio/mpeg,audio/PCMA,audio/tone" />
						</div>
					</div>
					<div class="block bw25 md-100 sm-100 xs-100" style="padding: 1em 2em 1em 0;">
