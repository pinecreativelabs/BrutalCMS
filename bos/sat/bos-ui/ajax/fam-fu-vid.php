...
<script src="fat/fam/fu/upload.js" type="text/javascript"></script>
	<div id="fam-fu-vid" class="op-panel charcoal">
		<div class="op-panelctrl solid-black">
			<div data-close="fam-fu-vid" class="op-panelbt op-bt-close">
				...
				<div class="block-wrap">
					<div class="block bw25 md-100 sm-100 xs-100" style="padding: 1em 2em 1em 0;">
						<div class="clean chonk monolisk charcoal-t" style="padding: 1em 1.25em; margin: 0 1.5em 0 0;">
							...
							<h4 class="heavy flow-text">File Uploader | <i class="bi bi-video"></i> Video</h4>
						</div>
					...
					<div class="block bw50 md-100 sm-100 xs-100" style="padding: 1em 2em 1em 0;">
						<p class="smoke-t lucida padded warning" style="font-size: 1.1em;">All files will be uploaded to:<br />
							<span class="bigger bold">/rat/repo/files/video/</span>
						...
						<div class="fu padded unset-bg">
							<input class="FU" type="file" path="rat/repo/files/video/" startOn="manually" buttonCaption="Upload" buttonClass="fu-fb" multi="true" afterUpload="link" maxSize="<?php echo $maxFileSize; ?>" fileType="video/mp4,video/ogg,video/quicktime,video/raw,video/MPV,video/AV1,video/DV,video/BMPEG,video/FFV1"/>
						</div>
					</div>
					<div class="block bw25 md-100 sm-100 xs-100" style="padding: 1em 2em 1em 0;">
