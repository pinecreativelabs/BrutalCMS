	<div id="manage-pages" class="op-panel charcoal">
		<div class="op-panelctrl solid-black">
			<div data-close="manage-pages" class="op-panelbt op-bt-close">
				...
				<div class="block-wrap">
					<div class="block bw25 md-100 sm-100 xs-100">
						<div class="liminal chonk butter-t black-t-s" style="padding: 1em 1.25em; margin: 0 1.5em 0 0;">
							...
							<h4 class="lucida heavy flow-text"><i class="bi bi-file-edit"></i> Manage Pages</h4>
						</div>
					...
					<div class="block bw75 bh85">
						<div class="block-wrap">
							<div class="block bw100 bh85">
								<iframe src="fat/pages/module/page_edit_pages.php" title="Pages Manager" style="border: none; overflow-y: none; width: 100%; margin: 0 auto; padding: 0; height: 100%;"></iframe>
							</div>
						</div>
					</div>
				</div>
