...
require_once 'bos/molds/dick/view.php';
include_once 'bos/molds/blueprint/view.php';
?>
...
<div class="wrap-1200 bitstream">
	...
	<div class="bentogrid">
		...
		<div class="charcoal-b padded b-s-t wallpaper september" data-bento="3x1">
			<h3 class="flow-text">Audio Player</h3>
			<p>Jquery-based audio player</p>
			<?php echo $wallpaper_group_class_list;?>
		...
		<div class="charcoal-b padded b-s-t" data-bento="1x3">
			...
			<hr />
			<h4 class="flow-text">Blueprint Stats</h4>
			<p><strong><?php echo $layout_count;?> layouts<br /><?php echo $theme_count;?> themes<br /><?php echo $wp_count;?> wallpapers<br /><?php echo $wpg_count;?> wallpaper groups</strong></p>
		</div>
	</div>
	<!-- end bento grid -->
	<div class="block-wrap"><div class="block bw50 xs-100 sm-100">
		<?php echo $dick_config;?>
	</div><div class="block bw50 xs-100 sm-100">
		<?php echo $daily_content;?>
	</div></div>
	<p class="spacer"></p>
</div>
